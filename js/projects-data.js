...
const PROJECTS = [
  ...
  /* ============================================================
     ...
     ============================================================ */
  {
    slug: "fluent-manifold",
    category: "analysis",
    title: "Exhaust Manifold (ANSYS FLUENT)",
    summary: "Modeled a demo exhaust manifold with velocity / energy air inlets.",
    cover: "assets/projects/analysis/fluent-manifold/cover.png",
    gallery: [
      "assets/projects/analysis/fluent-manifold/gallery/cfd-mesh.png",
      "assets/projects/analysis/fluent-manifold/gallery/temp-soln.png",
      "assets/projects/analysis/fluent-manifold/gallery/inlet.png",
      "assets/projects/analysis/fluent-manifold/gallery/ext-temp.png",
    ],
    sections: [
      { heading: "Objective", body: "Demonstrate CFD modeling skills through implementation of a foundational flow system." },
      { heading: "Method", body: "Applied velocity and thermal conditions at the inlet. Defined walls and outlets." },
      { heading: "Results", body: "Developed a temperature contour over the walls and fluid body of the model. Predicted particle pathlines." },
      { heading: "Conclusion", body: "Validated FLUENT solver workflow in providing reasonable results for a typical exhaust manifold geometry." },
    ],
  },
  {
    slug: "ls-dyna-buckling",
    category: "analysis",
    title: "Buckling Failure (LS DYNA)",
    summary: "Modeled dynamic buckling in a cylindrical body loaded in axial compression.",
    cover: "assets/projects/analysis/ls-dyna-buckling/cover.png",
    gallery: [
      "assets/projects/analysis/ls-dyna-buckling/gallery/contour.png",
      "assets/projects/analysis/ls-dyna-buckling/gallery/xstrain.gif",
      "assets/projects/analysis/ls-dyna-buckling/gallery/dynamics.png",
      "assets/projects/analysis/ls-dyna-buckling/gallery/solver.png",
    ],
    sections: [
      { heading: "Objective", body: "Demonstrate dynamic modeling skills through implementation of a foundational failure mechanism." },
      { heading: "Method", body: "Defined axi-symmetric mesh and applied structural boundary conditions to simulate buckling." },
      { heading: "Results", body: "Developed a stress-strain time history and predicted modal failure from buckling." },
      { heading: "Conclusion", body: "Validated LS-DYNA solver workflow in providing reasonable results for a typical failure mode." },
    ],
  },
  {
    slug: "ansys-transient",
    category: "analysis",
    title: "Pressure Transient (ANSYS MECHANICAL)",
    summary: "Modeled transient pressure in a narrowing pipe.",
    cover: "assets/projects/analysis/ansys-transient/cover.png",
    gallery: [
      "assets/projects/analysis/ansys-transient/gallery/pipe_flow.gif",
    ],
    sections: [
      { heading: "Objective", body: "Demonstrate transient response modeling skills through implementation of a foundational internal loading configuration." },
      { heading: "Method", body: "Defined quarter symmetry mesh and applied a pressure time history along with structural boundary conditions." },
      { heading: "Results", body: "Developed a stress-strain time history at structural time points from the pressure transient." },
      { heading: "Conclusion", body: "Validated ANSYS MECHANICAL solver workflow in providing reasonable results for a typical internal loading problem." },
    ],
  },
  {
    slug: "abaqus-cantilever",
    category: "analysis",
    title: "Cantilever Beam (ABAQUS)",
    summary: "Modeled point loading in a cantilevered beam.",
    cover: "assets/projects/analysis/abaqus-cantilever/cover.png",
    gallery: [
      "assets/projects/analysis/abaqus-cantilever/gallery/principal.png",
    ],
    sections: [
      { heading: "Objective", body: "Demonstrate structural modeling skills through implementation of a foundational beam deflection configuration." },
      { heading: "Method", body: "Defined components and mesh in ABAQUS with structural boundary conditions and loading definitions." },
      { heading: "Results", body: "Evaluated total deformation and principal stress across the mesh developed for the component." },
      { heading: "Conclusion", body: "Validated ABAQUS solver workflow in providing reasonable results for a typical beam deflection problem." },
    ],
  },
